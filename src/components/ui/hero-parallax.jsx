  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold text-foreground">
        Premium Properties <br /> We Help Fill
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-muted-foreground">
        We connect property managers with quality tenants across desirable locations,
        helping you fill vacancies with pre-screened, reliable renters.
      </p>
    </div>
  );
};
